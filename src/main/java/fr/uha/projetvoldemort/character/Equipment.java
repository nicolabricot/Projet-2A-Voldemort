...
public final class Equipment {
     ...
     * Si l'item ne peut pas être équipé.
     */
     ...
     * L'ancienne arme.
     * @throws UnexpectedItemException
     * Si l'arme ne peut pas être équipée.
     */
     ...
     * @return
     * Le total d'attaque des différents équipements
     */
    public int getAttack() {
        int attack = 0;
        attack += this.armor.getAttack();
        if  (this.arm!=null) attack += this.arm.getAttack();
        return attack;
    }
     ...
     * @return
     * Le total de défense des différents équipements
     */
    public int getDefense() {
        int defense = 0;
        defense += this.armor.getDefense();
        if  (this.arm!=null) defense += this.arm.getDefense();
        return defense;       
    }
     ...
     * @return
     * Le total d'initiative des différents équipements
     */
    public int getInitiative() {
        int initiative = 0;
        initiative += this.armor.getInitiative();
        if  (this.arm!=null) initiative += this.arm.getInitiative();
        return initiative;
    }
     ...
     * @return
     * Le total de chance des différents équipements
     */
    public int getLuck() {
        int luck = 0;
        luck += this.armor.getLuck();
        if  (this.arm!=null) luck += this.arm.getLuck();
        return luck;
    }
     ...
     * @return
     * Le total de robustesse des différents équipements
     */
    public int getRobustness() {
        int robustness = 0;
        robustness += this.armor.getAttack();
        if  (this.arm!=null) robustness += this.arm.getRobustness();
        return robustness;
    }
}
